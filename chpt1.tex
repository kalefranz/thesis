...
\end{equation}
Applying Eq.~\eqref{chpt1eqn:discrete_derivative} to the above equation, gathering terms in $\psi_\tn{\tiny{C}}(z)$, and making the transformation $2 \delta z \rightarrow \delta z$ gives
\begin{equation}
